...
class ScheduleTest extends TestCase
{
    ...
    public function test_filter_appears_and_defaults_to_first_division_by_sequence()
    {
        ...
        $this->assertSame(1, substr_count($response->getContent(), 'View Full Schedule'));
    }
    ...
    public function test_all_divisions_cookie_shows_every_schedule()
    {
        ...
        $response = $this->withCookie('division_filter', 'all')
            ->get('http://testassoc.pinballleague.org/schedule');
    ...
    public function test_query_param_sets_cookie_and_redirects()
    {
        ...
        $response = $this->get('http://testassoc.pinballleague.org/schedule?division='.$alpha->id);

        $response->assertRedirect('http://testassoc.pinballleague.org/schedule');
    ...
    public function test_invalid_query_param_falls_back_to_first_division()
    {
        ...
        $response = $this->get('http://testassoc.pinballleague.org/schedule?division=999999');
