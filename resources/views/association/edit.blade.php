...
@section('content')
    ...
    <div class="form row">
        <form class="col" method="POST" action="{{ route('association.update', ['association' => $association]) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <a class="btn btn-primary" href="{{ route('association.homeImageDelete', [ 'association' => $association ]) }}">Delete Homepage Image File</a>
            </div>
            @else
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="favicon_metadata" name="favicon_metadata" rows="3">{{ old('favicon_metadata', $association->favicon_metadata) }}</textarea>
