                ...
                <div class="col-md-12">
                    ...
                    <form class="form-inline" method="POST" action="{{ route('result_submission.update', ['id' => $submission->id]) }}">
                        ...
                        <div class="form-group mr-2">
                            <label class="mr-sm-2" for="submission_{{ $submission->id }}_home_team_score">{{ $submission->match->homeTeam->name }}</label>
                        ...
                        <div class="form-group mr-2">
                            <label class="mr-sm-2" for="submission_{{ $submission->id }}_away_team_score">{{ $submission->match->awayTeam->name }}</label>
